...
import { baseUrl } from "../config"; //http://localhost:3000
...
const api = {
  baseOptions: function (params, method) {
    ...
    const option: IOption = {
      url: url.indexOf("http") !== -1 ? url : baseUrl + url, //  若url不以http开头，例 /login/cellphone,则为http://localhost:3000/login/cellphone
      data: data,
      method: method,
      header: {
